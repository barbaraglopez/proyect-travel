...
const pintarCards = (data) => {
    data.forEach((producto) =>{
        ...
        templateCard.querySelector("p.fecha").textContent = ` Sale el dia:${producto.fecha}`;
...
form.addEventListener("submit", (e) => {
    ...
    Swal.fire({
        title: "Ya estas registrad@!",
        text: "Ingresa a la pagina con los datos que registraste",
        icon: "success",
        confirmButtonText: "Ok",
    });
});
